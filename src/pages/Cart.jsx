          ...
          <div className="lg:col-span-1">
            <div className="bg-[#111827] border border-[#1f2937] rounded-2xl p-4 sticky top-24">
              ...
              <div className="mt-4 flex flex-col gap-2">
                <Link 
                  to="/checkout" 
                  className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 rounded-xl font-bold text-center hover:shadow-lg transition-all hover:scale-[1.02]"
                >
                  Proceed to Checkout
                </Link>
                <Link 
                  to="/" 
                  className="text-indigo-400 hover:text-indigo-300 text-sm font-medium text-center flex items-center justify-center gap-1"
                >
                  <FaArrowLeft /> Back to Home
                </Link>
              </div>
