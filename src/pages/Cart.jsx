        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="bg-[#111827] border border-[#1f2937] rounded-2xl p-4 sticky top-24">
              ...
              <Link 
                to="/checkout" 
                className="block mt-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 rounded-xl font-bold text-center hover:shadow-lg transition hover:scale-[1.02]"
              >
                Proceed to Checkout ✅
              </Link>
              ...
              <Link 
                to="/products" 
                className="block text-center text-indigo-400 hover:text-indigo-300 text-sm font-medium mt-3 transition"
              >
                Continue Shopping
              </Link>
            </div>
